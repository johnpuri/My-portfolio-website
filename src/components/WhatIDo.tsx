        ...
        <div className="what-box-in">
          ...
          >
            ...
            <div className="what-content-in">
              ...
              <p>
                Designing and managing production cloud infrastructure on GCP,
                building CI/CD pipelines with GitHub Actions, and shipping
                containerised microservices with Docker and Kubernetes.
              </p>
              <h5>Skillset & tools</h5>
              <div className="what-content-flex">
                <div className="what-tags">Google Cloud (GCP)</div>
          ...
          >
            ...
            <div className="what-content-in">
              ...
              <p>
                Building scalable back-end services with Java & Spring Boot,
                data pipelines in Python, and dynamic React front-ends —
                with a focus on clean APIs and enterprise-grade reliability.
              </p>
              <h5>Skillset & tools</h5>
              <div className="what-content-flex">
